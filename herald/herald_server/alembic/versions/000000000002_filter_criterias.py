...
def upgrade():
    ...
    field_table = op.create_table(
        "field",
        sa.Column("created_at", sa.Integer(), nullable=False, default=datetime.now(tz=UTC).timestamp),
    ...
    op.bulk_insert(field_table, fields)
    op.create_table(
        "filter_criteria",
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column("notification", sa.Column("event_ack", sa.Boolean(), nullable=True))
    op.add_column("notification", sa.Column("event_class", sa.String(length=32), nullable=True))
    op.add_column("notification", sa.Column("event_object_id", sa.String(length=36), nullable=True))
    op.add_column("notification", sa.Column("event_object_type", sa.String(length=64), nullable=True))
    op.add_column("notification", sa.Column("event_level", sa.String(length=64), nullable=True))
