...
class Migrator:
    ...
    def __init__(self, engine):
        ...
        self.alembic_cfg.set_main_option(
            "script_location", os.path.join(os.path.abspath(os.path.dirname(__file__)), "..", "alembic")
        )
    ...
    def do_upgrade(self, revision, context):
        ...
        :return:
        """
        return self.alembic_script._upgrade_revs(self.alembic_script.get_heads(), revision)
    ...
    def migrate(self):
        ...
        self.alembic_env.configure(connection=conn, target_metadata=target_metadata, fn=self.do_upgrade)
