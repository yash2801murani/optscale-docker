EMAIL_TEST_DATA = {
    ...
    "invite": {
        ...
        "template_params": {
            "texts": {
                "organization": {"id": "95a42273-2e87-4749-aa11-e60a61dcc0b8", "name": "ishorg", "currency_code": "$"}
            },
            "links": {
    ...
    "new_subscriber": {
        ...
        "template_params": {
            "texts": {
                "user": {"email": "me2@1.com", "subscribe": True},
            }
        },
    },
    "pool_exceed_report": {
                        ...
                        "resources": [
                            {
                                ...
                                "type": "instance",
                                "security_groups": [{"GroupId": "sg-0d99e8ecd70254ebe", "GroupName": "websites"}],
                                "tags": {"aws:createdBy": "IAMUser:AIDA4YBYU3OICYSASYZ2E:pkozlov"},
                            }
                        ],
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "resources": [
                            ...
                            },
                            {
                                ...
                                "type": "volume",
                                "volume_type": "gp2",
                                "tags": {"aws:createdBy": "Root:044478323321"},
                            },
                            {
                                "active": True,
                                "attached": False,
                            ...
                            },
                            {
                                ...
                                "pool_purpose": "business_unit",
                                "region": "us-west-1",
                                "resource_id": "e68ddee4-7e2a-42ee-a21a-5999e0cc3fee",
                                "last_seen": 1617152176,
                                "size": 30,
                                "state": "completed",
                                "type": "snapshot",
                            ...
                            },
                            {
                                ...
                                "type": "bucket",
                                "tags": {"aws:createdBy": "IAMUser:AIDAJGWH6JNRGDXONCBLI:va-iam-full"},
                            },
                            {
                                "active": True,
                                "cloud_account_id": "ba5a7439-df3a-4d41-9244-4927b80770f2",
                                ...
                                "type": "bucket",
                                "tags": {"aws:createdBy": "IAMUser:AIDAIPPYCHRYQONGDLRJS:pk-full"},
                            },
                        ],
                    },
                ],
    ...
    "pool_owner_violation_report": {
        ...
        "template_params": {
            "texts": {
                ...
                "total_violated": 2,
                "differ_resources": [],
                "organization": {"id": "28eef4b1-4acf-4050-b833-86c3b2aaf1e7", "name": "Lori Inc"},
                "violated_resources": [
                    {
    ...
    "weekly_expense_report": {
        ...
        "template_params": {
            "texts": {
                ...
                "unassigned": {"forecast": 224.81, "total_cost": 210.3, "resources_tracked": 540},
            }
        },
    },
    "bumi_task_execution_failed": {
        ...
        "template_params": {
            "texts": {
                "organization": {"id": "6946211f-47ff-43a3-a9a3-3e5f57d52415", "name": "Czar Pictures"},
                "reason": "Timeout error while process task 1639638582 (organization_id b74f3ca6-c392-4bcb-96b3-2ffaa0281810)",  # noqa: E501
                "failed_modules": [
                    {
    ...
    "bumi_module_execution_failed": {
        ...
        "template_params": {
            "texts": {
                "organization": {"id": "b8835bce-da4c-4c29-98a0-4b4967baba53", "name": "Czar Pictures"},
                "failed_modules": [{"module": "short_living_instances", "error": "name 'LOG' is not defined"}],
            }
        },
    },
    ...
    "report_import_failed": {
        ...
        "template_params": {
            "texts": {
                "organization": {"id": "5d3d4501-0de8-40dc-a9ed-df2fb1396141", "name": "am2"},
                "cloud_account": {
    ...
    "environment_changes": {
        ...
        "template_params": {
            "texts": {
                ...
                "user": {"user_display_name": "ASBalmah_Engineer"},
                ...
                "environment_prop_changed": {
                    "changed_environment": {
                        "property_info": [
                            {"name": "Purpose", "previous_value": "Staging", "new_value": "Production"},
                            {"name": "Purpose2", "previous_value": "Staging2", "new_value": "Production2"},
                        ],
                        "name": "Test_Environment",
                        "id": "5dba5d14-d385-4b29-a426-b37160d1adbf",
                    }
                ...
                "environments_infos": {
                    ...
                    "jira_tickets": [
                        {"url": "https://jira.com.example/NGUI-1242", "name": "NGUI-1242"},
                        {"url": "https://jira.com.example/NGUI-3214", "name": "NGUI-3214"},
                    ],
                    ...
                    "upcoming_bookings": [
                        {
                            ...
                            "status_info": {"Status": "<upcoming booking status>"},
                        }
                    ],
                    "contains_envs": True,
                    "env_properties": [
                        {"env_key": "Purpose", "env_value": "Production"},
                        {"env_key": "Software version", "env_value": "v1.2.32141"},
                    ],
                },
    ...
    "anomaly_detection_alert": {
        ...
        "template_params": {
            "texts": {
                ...
                "filters": [{"filter_name": "pool", "filter_values": "Pool1(b1d60c69-4e14-4bda-be16-dc8fc6d8b941)"}],
                "limit_hit": {
    ...
    "new_security_recommendation": {
        ...
        "template_params": {
            "texts": {
                ...
                "modules": [
                    {"module": "Public Amazon S3 buckets", "count": 1},
                    {"module": "Instances with insecure Security Groups settings", "count": 2},
                    {"module": "Inactive IAM users", "count": 3},
                    {"module": "IAM users with unused console access", "count": 4},
                ],
                "user": {"user_display_name": "james31"},
            }
        },
    },
    "saving_spike": {
        ...
        "template_params": {
            "texts": {
                ...
                "organization_constraint": {
                    ...
                    "tagging_policy": False,
                    "id": "c063973e-0bb2-4134-9ebe-2e68104d7aa8",
                    "definition": {"total_budget": 1000, "start_date": 1645443900},
                },
                "filters": [{"filter_name": "pool", "filter_values": "Pool1(b1d60c69-4e14-4bda-be16-dc8fc6d8b941)"}],
                "limit_hit": {
                    "created_at": "02/21/2022 11:45 AM UTC",
