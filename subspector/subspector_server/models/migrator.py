...
import subspector.subspector_server.models.models

LOG = logging.getLogger(__name__)

# declarative base metadata
target_metadata = subspector.subspector_server.models.models.Base.metadata
...
class Migrator:
    ...
    def migrate(self):
        ...
        self.alembic_env.configure(
            ...
            fn=lambda rev, context: self.do_upgrade(rev, context)
        )
    ...
    def migrate_all(self):
        try:
            ...
            LOG.error('Failed to apply migrations: %s', repr("".join(tb_lines)))
            raise
