    ...
    if not version or version == 'v2':
        ...
        result.extend([
            ...
            (urls_v2.cloud_account,
             ...
             handler_kwargs),
            (urls_v2.cloud_policies,
             h_v2.policy_gen.PolicyGeneratorAsyncCollectionHandler,
             handler_kwargs),
            ...
            (urls_v2.breakdown_tags,
             ...
             handler_kwargs),
            (urls_v2.breakdown_meta,
             h_v2.breakdown_meta.BreakdownMetaAsyncHandler,
             handler_kwargs),
            ...
            (urls_v2.k8s_rightsizing, h_v2.k8s_rightsizing.K8sRightsizingAsyncHandler,
             handler_kwargs),
            (urls_v2.risp_processing_tasks,
             h_v2.risp_processing_tasks.RispProcessingTaskAsyncItemHandler,
             handler_kwargs),
            (urls_v2.risp_processing_tasks_collection,
             h_v2.risp_processing_tasks.RispProcessingTaskAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.org_bi_collection,
             h_v2.organization_bis.OrganizationBIAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.bi_collection,
             h_v2.organization_bis.BIAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.bi,
            ...
            (urls_v2.relevant_flavors, h_v2.relevant_flavors.RelevantFlaforsAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.organization_geminis_collection,
             h_v2.organization_geminis.OrganizationGeminisAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.geminis_collection,
             h_v2.organization_geminis.GeminisAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.geminis,
             h_v2.organization_geminis.GeminisAsyncItemHandler,
             handler_kwargs),
            (urls_v2.geminis_data,
             h_v2.organization_geminis.GeminisDataAsyncItemHandler,
             handler_kwargs),
            (urls_v2.geminis_data_collection,
             h_v2.organization_geminis.GeminisDataAsyncCollectionHandler,
             handler_kwargs),
            (urls_v2.geminis_data_download,
             h_v2.organization_geminis.GeminiDataDownloadHandler,
             handler_kwargs),
            ...
            (urls_v2.layouts,
             ...
             handler_kwargs),
            (urls_v2.ri_breakdown,
             h_v2.ri_breakdowns.RiBreakdownAsyncHandler,
             handler_kwargs),
            (urls_v2.sp_breakdown,
             h_v2.sp_breakdowns.SpBreakdownAsyncHandler,
             handler_kwargs),
